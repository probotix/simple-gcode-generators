...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.PathVar = IntVar()
        self.PathVar.set(0)
        Radiobutton(self.EntryFrame, text='Parallel', variable=self.PathVar, value = 0, command=self.DoIt ,indicatoron=0,width=7,).grid(row=self.rownumber+1, column=0, sticky = E)
    ...
    def DoIt(self):
        ...
        self.gcode.append('( updated by PROBOTIX 2024 )')
